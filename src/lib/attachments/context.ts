...
function attachmentInstructionBlock(structuredExplain: boolean): string {
  ...
  if (structuredExplain) {
    core.push(
      ...
      "",
      "**Formatting quality rules (required)**:",
      "- Start with a 1-2 sentence direct summary before long detail.",
      "- Keep lists flat and clean. Do not emit broken mixed numbering like `Executive Summary 2. 1. Introduction`.",
      "- Use either bullets OR numbered lists per section; never nested numbering unless absolutely necessary.",
      "- Keep each bullet to one idea. Add blank lines between major sections for breathing room.",
      "- In `Main contents`, list section names only (short). Put explanations in `Simple explanation`.",
      "",
      "## What this file is",
      ...
      "",
      "## Main contents",
      "— Break the document into **sections, parts, numbered tasks, or questions exactly as they appear** in the extract. Use a short clean list (no long paragraphs). If the extract has headings or “Task 1 / Question 2” labels, preserve them but normalize formatting.",
      "",
      "## Simple explanation",
      "— **Teach the material in plain language**: for each major section or task you listed, add a short explanation of what it means and what the reader is supposed to do. Prefer bold labels per section (or `###` only if truly needed). This is the core of the answer — not a vague overview.",
      "",
      "## Key takeaways",
      ...
      "— If the document is a report, assignment, analysis, or write-up, add a short reviewer-style section with 2-4 strengths and 2-4 weaknesses based on visible text quality (clarity, evidence, structure, missing confirmations). Keep this concise and practical.",
      "",
