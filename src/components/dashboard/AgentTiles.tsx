    ...
    <div>
      <div className="mb-4 flex items-center justify-between">
        ...
        <Link
          href="/discover"
          className={cn(
            "flex items-center gap-1 text-sm font-medium text-[var(--text-muted)] transition hover:text-white",
            focusRing,
          )}
        >
          View all
            ...
            >
              ...
              <div className="relative min-w-0 flex-1">
                <div className="flex items-center gap-2">
                  ...
                  {badge && (
                    <span className="rounded-full bg-violet/15 px-2 py-0.5 text-[12px] font-semibold text-violet-light">
                      {badge}
                    </span>
                  )}
                </div>
                <p className="mt-0.5 text-sm leading-relaxed text-[var(--text-dim)]">
                  {description}
                </p>
              </div>
