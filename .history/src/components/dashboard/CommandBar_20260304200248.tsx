        ...
        <div className="group relative rounded-2xl border border-white/[0.08] bg-[var(--bg-card)] shadow-2xl shadow-black/30 transition-all duration-300 focus-within:border-violet/25 focus-within:shadow-violet/5 hover:border-white/[0.12]">
          ...
          <div className="relative">
            <textarea
              ...
              className="w-full resize-none bg-transparent px-5 pb-3 pt-5 text-base text-white placeholder:text-[var(--text-dim)] focus:outline-none"
      ...
      <div className="mt-3 flex flex-wrap items-center justify-center gap-2">
        {suggestedPrompts.map((prompt) => (
          <button
            ...
            className={cn(
              "rounded-full border border-white/[0.06] bg-white/[0.02] px-3.5 py-1.5 text-sm font-medium text-[var(--text-muted)] transition",
