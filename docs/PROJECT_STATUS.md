...
**Nexora** is an AI Agentic Search & Action platform built with Next.js 16, React 19, and TypeScript. The tagline is *"One platform. Every AI. Search → Action."*
...
*This document reflects the codebase state as of 10 March 2026 on the `main` branch.*
